...
function smMenu() {
  ...
  /*  $('#header .logo').after('<div class="mobile-button hidden-xs"><button id="mobile-menu"><img src="/images/bars.png"></button><div>');*/
	...
	$('.header-index .socblock').after('<div class="mobile-button visible-sm visible-xs"><button id="mobile-menu"><img src="/images/bars.png"></button><div>');
	
	$('.mob-menu').after('<div class="mobile-button visible-sm visible-xs"><button id="mobile-menu"><img src="/images/bars2.png"></button><div>');
